# Fortunate-FrontEnd
This is a shadow repository for the Fortunate Trading application's front-end. Unfortunately, the codebase of the original application can't be shared right now. The application is still under construction. Therefore, some screenshots from the main application are shown below:
